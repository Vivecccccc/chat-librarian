...
VECTORSTORE_CONV_SAVE_ROOT_FOR_ADMIN = ".data/reserve/_session/chat/embeddings/"
VECTORSTORE_CONV_SAVE_ROOT_FOR_USER = ".data/transient/_session-%s/chat/embeddings/"
